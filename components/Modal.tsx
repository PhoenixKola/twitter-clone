    ...
    return ( 
        <>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70">
                <div className="relateive w-full lg:w-3/6 my-6 mx-auto lg:max-w-3xl h-full lg:h-auto">
                    <div className="h-full lg:h-auto border-0 rounded-lg relative flex flex-col w-full bg-black outline-none focus:outline-none">
                        ...
                        <div className="flex items-center justify-between p-10 rounded-t">
                            ...
                            <button onClick={handleClose} className="p-1 ml-auto border-9 text-white hover:opacity-70 transition">
